...
pygame.display.set_caption('First game!') # ---Set the title of the window
...
WINNING_SOUND = pygame.mixer.Sound(os.path.join('Assets', 'mixkit-retro-game-notification-212.wav'))
